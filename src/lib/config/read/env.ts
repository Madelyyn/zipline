...
export const ENVS = [
  ...
  env('chunks.max', 'CHUNKS_MAX', 'number', true),
  env('chunks.size', 'CHUNKS_SIZE', 'byte', true),
  env('chunks.enabled', 'CHUNKS_ENABLED', 'boolean', true),

  env('tasks.deleteInterval', 'TASKS_DELETE_INTERVAL', 'ms', true),
  env('tasks.clearInvitesInterval', 'TASKS_CLEAR_INVITES_INTERVAL', 'ms', true),
  env('tasks.maxViewsInterval', 'TASKS_MAX_VIEWS_INTERVAL', 'ms', true),
  env('tasks.thumbnailsInterval', 'TASKS_THUMBNAILS_INTERVAL', 'ms', true),
  env('tasks.metricsInterval', 'TASKS_METRICS_INTERVAL', 'ms', true),
  ...
  env('files.maxFileSize', 'FILES_MAX_FILE_SIZE', 'byte', true),
  env('files.defaultExpiration', 'FILES_DEFAULT_EXPIRATION', 'ms', true),
  ...
  env('features.versionAPI', 'FEATURES_VERSION_API', 'boolean', true),
  ...
  env('ratelimit.window', 'RATELIMIT_WINDOW', 'ms', true),
